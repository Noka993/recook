...
def update_recipe(recipe_id):
    ...
    recipe.number_of_favorites = data.get(
        "numberOfFavorites", recipe.number_of_favorites
    )
...
def create_user():
    ...
    new_user = User(
        username=data.get("username"), password_hash=data.get("passwordHash")
    )
...
def add_favorite():
    ...
    new_favorite = Favorite(
        user_id=favorite_data["userId"], recipe_id=favorite_data["recipeId"]
    )
